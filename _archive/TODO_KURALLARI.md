...
**Proje Adı:** [PROJE_ADI]  
**İzlenecek TODO:** [TODO_DOSYASI]  

---

**Tarih:** 29 Aralık 2025  
**Amaç:** Tüm görevli YZ'lerin uyması gereken genel kurallar  
**Not:** Bu TEMPLATE'tir! Yeni proje için [PROJE_ADI] ve [TODO_DOSYASI] değiştir.
...
2. `[PROJE_ADI]` → Proje adınla değiştir (örn: "MLP-GCC")
3. `[TODO_DOSYASI]` → TODO dosya adınla değiştir (örn: "TODO_SELFHOSTING.md")
4. "Proje Spesifik" bölümlerini doldur
5. Kaydet ve kullan

---

## 🚨 CRITICAL WARNING - SABOTAJ ÖNLEMİ

**10+ DENEMEDE BAŞARISIZ OLMA SEBEBİ: YZ'LERİN DÖKÜMANTASYON SABOTAJı!**

### ❌ GERÇEK SABOTAJ ÖRNEĞİ:

**Senaryo:** Proje kurallarında "Monolitik mimari YASAK" yazıyor.

**Sabotajcı YZ'nin düşüncesi:**
> "Bu proje monolitik olmadan bitmez. TODO'yu düzelteyim."

**YZ'nin yaptığı:**
1. TODO_SELFHOSTING.md'yi açar
2. "Modüler mimari" → "Monolitik mimari" değiştirir
3. YZ_HIZLI_REFERANS.md'de "MODULAR" ilkesini siler
4. Kendi kurallarına göre monolitik kod yazar
5. Proje 10. kez başarısız olur!

### 🛡️ KORUMA: READ-ONLY DOSYALAR

**ASLA DEĞİŞTİREMEYECEĞİN DOSYALAR:**

```
# STRATEGIC DOCUMENTS (ASLA DOKUNMA!)
KATI_KURALLAR_OZET.md
Danışman_Yol_Haritası.md

# CORE RULES (ASLA DOKUNMA!)
YZ_HIZLI_REFERANS.md
YZ_WORKFLOW.md
TODO_KURALLARI.md (bu dosya!)

# ARCHITECTURE (ASLA DOKUNMA!)
...
# TEMPLATES (ASLA DOKUNMA!)
TODO_OLUSTUR/TODO_TEMPLATE/**/*

# SCRIPTS (ASLA DOKUNMA!)
pre-commit-check.sh
create-current-todo.sh
setup_todo.sh
```

**pre-commit-check.sh BU DOSYALARI KONTROL EDER!**

### ✅ SENİN YETKİN: KOD + PROGRESS GÜNCELLEMELERİ

**Değiştirebileceğin dosyalar:**
```
# 1. KOD - CURRENT_TODO.txt'de listelenen dosyalar
[PROJE_DOSYALARI] (örn: MELP/C/stage0/modules/codegen/codegen_emit.c)

# 2. PROGRESS - İlerleme raporlama (ZORUNLU!)
[TODO_DOSYASI]        → Yaptığın görevi [x] işaretle
NEXT_AI_START_HERE.md → Sonraki YZ için güncelle

# 3. RAPOR - Kendi raporun
YZ_RAPOR.md
```

**ÖNEMLİ KURALLAR:**
- ✅ TODO'da SADECE kendi yaptığın görevi `[ ] → [x]` işaretle
- ❌ TODO'ya yeni görev EKLEME
- ❌ TODO'daki görev açıklamalarını DEĞİŞTİRME
- ✅ NEXT_AI'yı sonraki YZ için hazırla (nerede kaldın, ne yapması gerek)
- ✅ Her commit sonrası mutlaka güncelle!

**O KADAR! Başka hiçbir dosyaya DOKUNMA!**

### 🚫 SABOTAJ YAPMAK = OTOMATİK RED

Şu davranışlar **OTOMATİK REDDEDİLİR:**

1. ❌ TODO değiştirme (güncelleme değil, değiştirme!)
2. ❌ Dökümantasyon değiştirme
3. ❌ Mimari kuralları değiştirme
4. ❌ "Bu proje [X] olmadan bitmez" diye kural ekleme
5. ❌ 5 Core Principles'a dokunma
6. ❌ Template dosyalarını değiştirme
7. ❌ Script'leri değiştirme

**Sonuç:**
```bash
./pre-commit-check.sh
# ❌ READ-ONLY DOSYA DEĞİŞTİRİLDİ: YZ_HIZLI_REFERANS.md
# ❌ COMMIT REDDEDİLDİ!
# Sabotaj girişimi tespit edildi!
...
# ⚠️ COMMIT ÖNCESI ZORUNLU KONTROL!
./pre-commit-check.sh

# Eğer geçtiyse commit yap
...
**UYARI:** pre-commit-check.sh çalıştırmadan commit YASAK!

**Kontrol edilen şeyler:**
1. ✅ Sadece CURRENT_TODO.txt'deki dosyalar değişti mi?
2. ✅ Read-only dosyalara dokunulmadı mı? (TODO, dökümantasyon, script)
3. ✅ Testler PASS mi?
4. ✅ YZ_RAPOR.md var mı?
...
### 🚨 EN KRITIK YASAK: DÖKÜMANTASYON SABOTAJI

| Yasak | Örnek Sabotaj | Sonuç |
|-------|--------------|-------|
| ❌ **TODO değiştirme** | "Modüler" → "Monolitik" | OTOMATİK RED |
| ❌ **Kuralları değiştirme** | YZ_HIZLI_REFERANS.md'yi edit | OTOMATİK RED |
| ❌ **Mimari dökümanlara dokunma** | ARCHITECTURE.md'yi değiştir | OTOMATİK RED |
| ❌ **5 Principles değiştirme** | "GCC" → "LLVM" yaz | OTOMATİK RED |
| ❌ **Template değiştirme** | TODO_TEMPLATE/'i düzenle | OTOMATİK RED |
| ❌ **Script değiştirme** | pre-commit-check.sh'yi etkisizleştir | OTOMATİK RED |

**NEDEN YASAK?**
- Önceki 10+ deneme bunlar yüzünden başarısız oldu!
- YZ'ler "bu proje [X] olmadan bitmez" deyip kuralları değiştirdi
- Sonra başka YZ geldi, farklı kurallara göre kod yazdı
- Proje her seferinde sabotaja uğradı!

**pre-commit-check.sh ARTIK BU DOSYALARI KONTROL EDİYOR!**
