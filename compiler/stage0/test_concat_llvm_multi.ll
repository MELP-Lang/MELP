...
entry:
  ...
  store i8* %tmp1, i8** %greeting_ptr, align 8
    ...
    %tmp3 = getelementptr inbounds [2 x i8], [2 x i8]* @.str.2, i64 0, i64 0
  ; String concatenation
  %tmp4 = call i8* @mlp_string_concat(i8* %tmp2, i8* %tmp3)
    %tmp5 = getelementptr inbounds [6 x i8], [6 x i8]* @.str.3, i64 0, i64 0
  ; String concatenation
  %tmp6 = call i8* @mlp_string_concat(i8* %tmp4, i8* %tmp5)
    store i64 %tmp6, i64* %message, align 8
  %tmp8 = load i8*, i8** %message_ptr, align 8
  call void @mlp_println_string(i8* %tmp8)
    ret i64 0
}
