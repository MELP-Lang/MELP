...
class ConfigLoader {
  ...
  async loadConfigs() {
    try {
      // Sabit dil listesi — diller.json kaldırıldı
      this.languages = [
        { id: 'tr-TR', name: 'Türkçe',   keywords: {} },
        { id: 'en-US', name: 'English',   keywords: {} },
        { id: 'ru-RU', name: 'Русский',   keywords: {} },
        { id: 'ar',    name: 'عربي',      keywords: {} },
        { id: 'zh',    name: '中文',      keywords: {} },
      ];
